...
public class NotesController {
	...
	@GetMapping
	public List<Notes> viewNotesList() {
		return notesService.listAll();
	}
	
	@PostMapping
	public Notes Upload(@RequestBody Notes notes)  {
	...
	public Notes editNotes(@PathVariable("id") Long id, @RequestBody Notes note) {
		return notesService.updateNotes(id, note);
